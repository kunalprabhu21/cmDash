...
import 'package:admin_panel_responsive_flutter/pages/files/ViewTaskDetails.dart';
...
class FilesTaskDetails extends StatefulWidget {
  @override
  _FilesTaskDetailsState createState() => _FilesTaskDetailsState();
}

class _FilesTaskDetailsState extends State<FilesTaskDetails> {
  int currentIndex = 1;
      ...
      body: ResponsiveLayout(
        ...
        computer: Row(
          children: [
            ...
            Expanded(child: ViewTaskDetails()),
