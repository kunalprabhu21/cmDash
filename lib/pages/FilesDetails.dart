...
class FilesDetails extends StatefulWidget {
  @override
  _FilesDetailsState createState() => _FilesDetailsState();
}

class _FilesDetailsState extends State<FilesDetails> {
  int currentIndex = 1;
